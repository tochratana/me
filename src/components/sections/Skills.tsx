      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-16">
          {Object.entries(skillsData).map(([category, skills]) => (
            <div
              key={category}
              className="bg-card border border-border rounded-lg p-5 hover:border-[var(--hero-accent)]/50 transition-all duration-300 hover:shadow-lg group"
            >
              <h3 className="text-sm font-bold mb-4 flex items-center gap-2">
                <div className="w-6 h-6 rounded-md bg-[var(--hero-accent)]/10 flex items-center justify-center group-hover:bg-[var(--hero-accent)]/20 transition-colors">
                  <Server size={14} className="text-[var(--hero-accent)]" />
                </div>
                ...
                {skills.map((skill) => (
                  <div key={skill.name} className="group/item">
                    <div className="flex items-center gap-2 p-2 bg-background/50 rounded-md hover:bg-accent/50 transition-all duration-200">
                      ...
                      <span className="text-xs font-medium group-hover/item:text-[var(--hero-accent)] transition-colors line-clamp-1">
                        {skill.name}
                      </span>
                    </div>
                  </div>
